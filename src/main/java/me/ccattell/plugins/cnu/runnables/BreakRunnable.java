...
import me.ccattell.plugins.cnu.database.SkillsResultSet;
import me.ccattell.plugins.cnu.utilities.ToolBoost;
...
public class BreakRunnable implements Runnable {
    ...
    public void run() {
        ...
        BukkitWorker<Boolean, String, CompleteNovusUtilities> worker = new BukkitWorker<Boolean, String, CompleteNovusUtilities>(plugin) {
