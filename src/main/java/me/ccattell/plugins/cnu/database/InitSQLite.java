...
public class InitSQLite {
    ...
    public void initSQLite() {
        try {
            ...
            String queryCNU = "CREATE TABLE IF NOT EXISTS CNUMain (player_name TEXT PRIMARY KEY COLLATE NOCASE, cash REAL DEFAULT 0.0, bank REAL DEFAULT 0.0, xp REAL DEFAULT 0.0, last_login INTEGER DEFAULT 0)";
