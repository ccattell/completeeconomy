...
public class InitMySQL {
    ...
    public void initMYSQL() {
        try {
            ...
            String queryCNU = "CREATE TABLE IF NOT EXISTS CNUMain (player_name text NOT NULL, cash float NOT NULL, bank float NOT NULL, xp float NOT NULL, last_login int(11) NOT NULL) CHARACTER SET utf8 COLLATE utf8_general_ci";
