...
public class CEInitSQLite {
    ...
    public void initSQLite() {
        try {
            ...
            String queryJobs = "CREATE TABLE IF NOT EXISTS CEJobs (player_name TEXT PRIMARY KEY COLLATE NOCASE, job text NOT NULL, experience INTEGER DEFAULT 0, level INTEGER DEFAULT 0)";
